...
activities = {
    ...
    "Soccer Team": {
        "description": "Team-based soccer drills and competitive matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "maya@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training, lap practice, and water safety",
    ...
    "Drama Club": {
        "description": "Acting, improv, and stage production practice",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["ethan@mergington.edu", "isabella@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for science competitions and lab challenges",
